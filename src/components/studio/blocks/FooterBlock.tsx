      ...
      <div className="sx-reveal" style={{ maxWidth: 1180, margin: '0 auto', padding: '0 32px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(150px,1fr))', gap: 40, paddingBottom: 44, borderBottom: '1px solid rgba(255,255,255,.14)' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, fontFamily: "var(--font-body,'Manrope')", fontSize: '14.5px', opacity: 0.7 }}><a href="#" className="sx-link" style={{ color: 'inherit', textDecoration: 'none' }}>Features</a><a href="#" className="sx-link" style={{ color: 'inherit', textDecoration: 'none' }}>Templates</a><a href="#" className="sx-link" style={{ color: 'inherit', textDecoration: 'none' }}>Pricing</a><a href="#" className="sx-link" style={{ color: 'inherit', textDecoration: 'none' }}>Changelog</a></div>
          </div>
          <div>
            <div style={{ fontFamily: "var(--font-body,'Manrope')", fontWeight: 700, fontSize: 14, marginBottom: 14, opacity: 0.95 }}>Company</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, fontFamily: "var(--font-body,'Manrope')", fontSize: '14.5px', opacity: 0.7 }}><a href="#" className="sx-link" style={{ color: 'inherit', textDecoration: 'none' }}>About</a><a href="#" className="sx-link" style={{ color: 'inherit', textDecoration: 'none' }}>Blog</a><a href="#" className="sx-link" style={{ color: 'inherit', textDecoration: 'none' }}>Careers</a><a href="#" className="sx-link" style={{ color: 'inherit', textDecoration: 'none' }}>Contact</a></div>
          </div>
          <div>
            <div style={{ fontFamily: "var(--font-body,'Manrope')", fontWeight: 700, fontSize: 14, marginBottom: 14, opacity: 0.95 }}>Legal</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, fontFamily: "var(--font-body,'Manrope')", fontSize: '14.5px', opacity: 0.7 }}><a href="#" className="sx-link" style={{ color: 'inherit', textDecoration: 'none' }}>Privacy</a><a href="#" className="sx-link" style={{ color: 'inherit', textDecoration: 'none' }}>Terms</a><a href="#" className="sx-link" style={{ color: 'inherit', textDecoration: 'none' }}>Security</a></div>
          </div>
        </div>
